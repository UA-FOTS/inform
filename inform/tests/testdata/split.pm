...
module compartmental_model
	...
	[] (q=1)&(t0_0=0) -> (q'=2);
	//Do Bernouilli Trial
	[] (q=1)&(t0_0>0) -> 0.2:(t0_0'=t0_0-1)&(fr0' = fr0 + 1) + 0.8:(t0_0'=t0_0-1); 
	...
	[] (q=3)&(t1_0=0) -> (q'=4);
	//Do Bernouilli Trial
	[] (q=3)&(t1_0>0) -> 0.3:(t1_0'=t1_0-1)&(fr1' = fr1 + 1) + 0.7:(t1_0'=t1_0-1); 

	//Update all values and go back to initial state
	[] (q=4)&((c0 >=fr0+fr1)) -> (q'=0)&(c0'=c0-fr0-fr1)&(c1'=c1+fr0)&(c2'=c2+fr1)&(fr0' = 0)&(fr1' = 0);
	[] (q=4)&((c0 <fr0+fr1)) -> (q'=5);
endmodule
