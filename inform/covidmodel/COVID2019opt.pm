...
module compartmental_model
    ...
    [] (q=2)&(tt0_2 = 0) -> (q'= 3)&(tt0_2' = c3);
    // do a single q trial 
    [] (q=3)&(tt0_2>0) -> 0.0127949398:(tt0_2'=tt0_2-1) + 0.9872050602:(q'=1)&(tt0_2'=0)&(fr0' = fr0 + 1); 
    // go to next dependency 
    [] (q=3)&(tt0_2 = 0) -> (q'= 4)&(tt0_2' = c4);
    // do a single q trial 
    [] (q=4)&(tt0_2>0) -> 0.0032247892:(tt0_2'=tt0_2-1) + 0.9967752108:(q'=1)&(tt0_2'=0)&(fr0' = fr0 + 1); 
    // go to next dependency 
    [] (q=4)&(tt0_2 = 0) -> (q'= 5)&(tt0_2' = c5);
    // do a single q trial 
    [] (q=5)&(tt0_2>0) -> 0.0032247892:(tt0_2'=tt0_2-1) + 0.9967752108:(q'=1)&(tt0_2'=0)&(fr0' = fr0 + 1); 
    // go back when chain is completed. 
    [] (q=5)&(tt0_2=0) -> (q'=1)&(tt0_2' = c2);
    //Go to final state
    [] (q=1)&(t0_0=0) -> (q'=6);
